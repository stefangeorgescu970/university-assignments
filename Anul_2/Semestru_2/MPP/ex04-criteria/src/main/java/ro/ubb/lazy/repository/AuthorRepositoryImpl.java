...
import javax.persistence.criteria.*;c
...
public class AuthorRepositoryImpl extends CustomRepositorySupport implements AuthorRepositoryCustom {
    ...
    public List<Author> findAllWithBooksAndPublisherCriteriaAPI() {
        ...
        Fetch<Author, Book> authorBookFetch = root.fetch(Author_.books, JoinType.LEFT);
        authorBookFetch.fetch(Book_.publisher, JoinType.LEFT);
