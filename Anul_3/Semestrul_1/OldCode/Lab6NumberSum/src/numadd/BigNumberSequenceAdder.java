...
public class BigNumberSequenceAdder {
    ...
    public static int[] parallelAddBigNumberSequence(int numbers[][]) {
        ...
        SynchronizedQueue digitQueue = new SynchronizedQueue();
    ...
    private void addAllBigNumbersInRange(int numbers[][], int beginIndex, int endIndex, SynchronizedQueue digitQueue) {
        if (beginIndex == endIndex) {
            ...
            SynchronizedQueue lowerSequenceQueue = new SynchronizedQueue();
            SynchronizedQueue higherSequenceQueue = new SynchronizedQueue();
